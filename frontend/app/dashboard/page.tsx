...
<div className="flex min-h-screen bg-[#030712] text-white">
    ...
    <main className="flex-1 overflow-y-auto">
       ...
       <div
  className="fixed top-0 right-0 bottom-0 w-[83%] z-10 bg-no-repeat"
  style={{
...
<div className="fixed inset-0 -z-10 bg-gradient-to-r from-[#030712] via-[#030712]/80 to-transparent" />
            {/* Glow */}
{/* 
            <div className="absolute -top-60 left-0 h-[500px] w-[500px] rounded-full bg-cyan-500/10 blur-[180px]" />
            ...
            <div className="relative z-10 max-w-[1700px] mx-auto px-10 py-10">
                ...
                <div className="grid xl:grid-cols-[1fr_390px] gap-8 items-start">
                   ...
                   <h5
    className="mt-6 text-4xl font-black tracking-[-0.05em] leading-[0.95] text-white"
...
>
    AI Job Dashboard
                        ...
                        <p className="mt-6 max-w-4xl text-lg leading-9 text-zinc-400">
                            ...
                            Automate your complete job search workflow with AI.

                            Discover jobs, analyse resumes, send personalized

                            Gmail outreach, track replies and manage every
...
<div className="mt-10 flex flex-wrap gap-4">
  ...
  >
    ...
    <span>Analytics</span>
                    ...
                    <div className="rounded-3xl border border-cyan-500/20 bg-white/[0.03] backdrop-blur-2xl shadow-2xl overflow-hidden">

                        <div className="bg-gradient-to-r from-cyan-500/20 via-blue-500/10 to-purple-500/20 px-6 py-5 border-b border-white/10">
                            ...
                            <div>
                                ...
                                <div className="mt-2 rounded-xl border border-white/10 bg-black/30 p-4">
                                    ...
                                    <p className="break-all font-medium">
                                        ...
                                        {gmailProfile?.emailAddress ?? "Not Connected"}
...
<div className="mt-10 rounded-3xl border border-white/10 bg-white/[0.03] backdrop-blur-2xl overflow-hidden">
    ...
    <div className="border-b border-white/10 px-8 py-6 flex flex-col lg:flex-row justify-between lg:items-center gap-6">
...
<div className="grid lg:grid-cols-[1fr_1fr_auto] gap-6 items-end">
...
<div className="mt-6 grid grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-4">
...
<div className="mt-10 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-6 gap-6">

    {/* Status */}

    <div className="rounded-3xl border border-white/10 bg-white/[0.03] backdrop-blur-2xl p-6 hover:border-cyan-400/40 transition-all">
        ...
        <h2 className={`mt-5 text-3xl font-black ${loading ? "text-yellow-400":"text-green-400"}`}>
...
<div className="mt-10 grid xl:grid-cols-[1.6fr_420px] gap-8">
                    ...
                    <div className="flex flex-col lg:flex-row justify-between gap-8">
                        ...
                        <div className="w-full lg:w-[280px]">
                            ...
                            <button
                                onClick={startAgent}
                                disabled={loading}
                                className="mt-8 w-full h-14 rounded-2xl bg-gradient-to-r from-cyan-500 to-purple-600 font-bold hover:opacity-90 transition"
                            >
...
<div className="mt-10 grid xl:grid-cols-[1.7fr_420px] gap-8">
        ...
        <div className="rounded-3xl border border-white/10 bg-white/[0.03] backdrop-blur-2xl overflow-hidden">
            ...
            <div className="border-b border-white/10 px-8 py-6 flex items-center justify-between">
                ...
                <div>
                    ...
                    <p className="mt-2 text-zinc-500">
                        ...
                        Automatically tracked by your AI Agent
            ...
            {applications.length === 0 ? (
                ...
                <div className="py-24 flex flex-col items-center">
                    ...
                    <BriefcaseBusiness className="h-16 w-16 text-zinc-700"/>
                    ...
                    <p className="mt-3 text-zinc-500">
                        ...
                        Start your AI Agent to populate this dashboard.
                    ...
                    <table className="min-w-full">
                        ...
                        <thead className="border-b border-white/10">
                            ...
                            <tr>
                                ...
                                <th className="px-8 py-5 text-left text-xs uppercase tracking-wider text-zinc-500">
                            ...
                            {applications.map((application,index)=>(
                                ...
                                >
                                    ...
                                    <td className="px-8 py-6">
                                        ...
                                        <span className="rounded-full bg-green-500/15 px-4 py-2 text-xs text-green-300">
        ...
        <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-7">
                ...
                <div className="mt-6 h-2 rounded-full bg-zinc-800">
                    ...
                    <div className="h-2 w-[21%] rounded-full bg-purple-500"/>
        ...
        <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-7">
            ...
            <div className="mt-8 space-y-8">
                ...
                <div className="flex gap-4">
                    ...
                    <div className="h-3 w-3 rounded-full bg-orange-400 mt-2"/>
            ...
            <div className="mt-8 space-y-6">
                ...
                <div>
                    ...
                    <div className="h-3 rounded-full bg-zinc-800">
                        ...
                        <div className="h-3 w-[61%] rounded-full bg-cyan-500"/>
                ...
                <div>
                    ...
                    <div className="h-3 rounded-full bg-zinc-800">
                        ...
                        <div className="h-3 w-[22%] rounded-full bg-purple-500"/>
                ...
                <div>
                    ...
                    <div className="h-3 rounded-full bg-zinc-800">
                        ...
                        <div className="h-3 w-[17%] rounded-full bg-green-500"/>
